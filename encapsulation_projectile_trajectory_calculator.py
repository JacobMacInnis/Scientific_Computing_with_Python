...
def projectile_helper(speed, height, angle):
    """Utility function to calculate and display projectile details, coordinates, and trajectory."""
    ...
    print(graph.create_coordinates_table())  # Prints coordinate table
    print(graph.create_trajectory())  # Prints trajectory graph


# Call projectile_helper with example values
